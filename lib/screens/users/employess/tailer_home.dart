...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  Stream<List<TailerFinishingModel>>? productStream;

  @override
  void initState() {
    productStream = streamProvider.getTailerFinishStream(widget.empID.empID);
                          ...
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                ...
                                title: Text(
                                  'Product: ${item.productID.productId.name}  (${item.color.color})',
